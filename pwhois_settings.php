...
<div id="poststuff">
<div class="postbox">
<h3><?php _e('pWhois Pro', 'pwhois') ?></h3>
	<div class="inside">
	<?php _e('To have more options and define your own TLDs and whois servers you can get Powies WHOIS Pro','pwhois') ?>
	<br />
	WWW: <a href="https://powie.de/wordpress/powies-whois-pro/">powie.de</a>
    </div>
</div>
